...
public class NetsliceVldBuilder implements Builder<NetsliceVld> {
    ...
    public NetsliceVldBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceVldParams arg) {
    ...
    public NetsliceVldBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams arg) {
        this._name = arg.getName();
        this._vimNetworkName = arg.getVimNetworkName();
        this._ipProfile = arg.getIpProfile();
    }
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceVldParams) {
            this._nssConnectionPointRef = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceVldParams)arg).getNssConnectionPointRef();
            isValidArg = true;
        }
