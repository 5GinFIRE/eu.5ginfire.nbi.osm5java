package org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.netslicefgd;
...
import org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.classifier.common.MatchAttributes;
...
public class ClassifierBuilder implements Builder<Classifier> {
    ...
    public ClassifierBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Classifier arg) {
    ...
    public ClassifierBuilder(org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon arg) {
        this._id = arg.getId();
        this._name = arg.getName();
        this._rspIdRef = arg.getRspIdRef();
        this._matchAttributes = arg.getMatchAttributes();
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon) {
            this._id = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon)arg).getId();
            this._name = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon)arg).getName();
            this._rspIdRef = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon)arg).getRspIdRef();
            this._matchAttributes = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon)arg).getMatchAttributes();
            isValidArg = true;
        }
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Classifier) {
            this._nsdRef = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Classifier)arg).getNsdRef();
            this._nsdConnectionPointRef = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Classifier)arg).getNsdConnectionPointRef();
            isValidArg = true;
        }
