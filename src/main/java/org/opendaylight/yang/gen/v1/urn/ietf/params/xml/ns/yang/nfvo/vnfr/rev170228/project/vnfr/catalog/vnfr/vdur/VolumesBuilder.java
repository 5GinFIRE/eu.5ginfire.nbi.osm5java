package org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur;
...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceBus;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceType;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.volume.info.VolumeSource;
...
public class VolumesBuilder implements Builder<Volumes> {
    ...
    public VolumesBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo) {
            this._description = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getDescription();
            this._size = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getSize();
            this._volumeSource = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getVolumeSource();
            this._deviceBus = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getDeviceBus();
            this._deviceType = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getDeviceType();
            isValidArg = true;
        }
    ...
    private static final class VolumesImpl implements Volumes {
        ...
        private final org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceBus _deviceBus;
        private final org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceType _deviceType;
        ...
        @Override
        public org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceBus getDeviceBus() {
            return _deviceBus;
        }
        
        @Override
        public org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceType getDeviceType() {
            return _deviceType;
        }
