...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.netslicefgd.Classifier;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.netslicefgd.Rsp;
...
public class NetslicefgdBuilder implements Builder<Netslicefgd> {
    ...
    public NetslicefgdBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Netslicefgd arg) {
    ...
    public NetslicefgdBuilder(org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon arg) {
        this._id = arg.getId();
        this._name = arg.getName();
        this._shortName = arg.getShortName();
        this._vendor = arg.getVendor();
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Netslicefgd) {
            this._rsp = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Netslicefgd)arg).getRsp();
            this._classifier = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Netslicefgd)arg).getClassifier();
            isValidArg = true;
        }
        if (arg instanceof org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon) {
            this._id = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getId();
            this._name = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getName();
            this._shortName = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getShortName();
            this._vendor = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getVendor();
            this._description = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getDescription();
            this._version = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getVersion();
            isValidArg = true;
        }
