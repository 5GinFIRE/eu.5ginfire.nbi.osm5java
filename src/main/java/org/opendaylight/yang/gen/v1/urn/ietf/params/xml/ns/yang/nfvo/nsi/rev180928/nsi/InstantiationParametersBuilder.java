...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.netslice_params.NetsliceSubnet;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.netslice_params.NetsliceVld;
...
public class InstantiationParametersBuilder implements Builder<InstantiationParameters> {
    ...
    public InstantiationParametersBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams) {
            this._vimAccountId = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams)arg).getVimAccountId();
            this._sshKeys = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams)arg).getSshKeys();
            this._netsliceSubnet = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams)arg).getNetsliceSubnet();
            this._netsliceVld = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams)arg).getNetsliceVld();
            isValidArg = true;
        }
