...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.event.service.primitive.Parameter;
...
public class TerminateServicePrimitiveBuilder implements Builder<TerminateServicePrimitive> {
    ...
    public TerminateServicePrimitiveBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive) {
            this._seq = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive)arg).getSeq();
            this._name = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive)arg).getName();
            this._userDefinedScript = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive)arg).getUserDefinedScript();
            this._parameter = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive)arg).getParameter();
            isValidArg = true;
        }
