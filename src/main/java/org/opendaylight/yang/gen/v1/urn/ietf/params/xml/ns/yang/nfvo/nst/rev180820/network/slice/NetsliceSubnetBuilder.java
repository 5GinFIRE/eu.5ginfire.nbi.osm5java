...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.netslice.subnet.InstantiationParameters;
...
public class NetsliceSubnetBuilder implements Builder<NetsliceSubnet> {
    ...
    public NetsliceSubnetBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet arg) {
        this._id = arg.getId();
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet) {
            this._id = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).getId();
            this._description = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).getDescription();
            this._isSharedNss = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).isIsSharedNss();
            this._nsdRef = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).getNsdRef();
            this._instantiationParameters = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).getInstantiationParameters();
            isValidArg = true;
        }
