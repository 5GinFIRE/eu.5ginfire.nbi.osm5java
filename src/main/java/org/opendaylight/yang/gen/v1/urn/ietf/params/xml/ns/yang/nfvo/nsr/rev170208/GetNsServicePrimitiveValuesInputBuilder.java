...
public class GetNsServicePrimitiveValuesInputBuilder implements Builder<GetNsServicePrimitiveValuesInput> {
    ...
    public GetNsServicePrimitiveValuesInputBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.RpcCommon arg) {
        this._nsrIdRef = arg.getNsrIdRef();
        this._projectName = arg.getProjectName();
    }
    public GetNsServicePrimitiveValuesInputBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.RpcProjectName arg) {
        this._projectName = arg.getProjectName();
    }
