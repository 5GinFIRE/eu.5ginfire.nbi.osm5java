package org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.internal_vld_params;
...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.ip.profile.update.schema.DhcpParams;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.ip.profile.update.schema.DnsServer;
...
public class IpProfileBuilder implements Builder<IpProfile> {
    ...
    public IpProfileBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema) {
            this._ipVersion = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getIpVersion();
            this._subnetAddress = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getSubnetAddress();
            this._gatewayAddress = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getGatewayAddress();
            this._dnsServer = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getDnsServer();
            this._dhcpParams = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getDhcpParams();
            isValidArg = true;
        }
