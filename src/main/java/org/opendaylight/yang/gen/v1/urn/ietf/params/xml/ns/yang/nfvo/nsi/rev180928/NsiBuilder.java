...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.nsi.InstantiationParameters;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.nsi.NetworkSliceTemplate;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.nsi.NsrRefList;
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.nsi.VlrList;
...
public class NsiBuilder implements Builder<Nsi> {
    ...
    public NsiBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G arg) {
        this._id = arg.getId();
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G) {
            this._id = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getId();
            this._name = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getName();
            this._shortName = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getShortName();
            this._description = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getDescription();
            this._nstRef = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getNstRef();
            this._instantiationParameters = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getInstantiationParameters();
            this._networkSliceTemplate = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getNetworkSliceTemplate();
            this._nsrRefList = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getNsrRefList();
            this._vlrList = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getVlrList();
            isValidArg = true;
        }
