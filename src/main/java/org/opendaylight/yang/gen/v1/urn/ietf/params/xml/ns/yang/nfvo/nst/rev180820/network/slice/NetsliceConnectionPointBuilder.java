...
public class NetsliceConnectionPointBuilder implements Builder<NetsliceConnectionPoint> {
    ...
    public NetsliceConnectionPointBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.SliceConnectionPoints arg) {
        this._connection = arg.getConnection();
        this._name = arg.getName();
        this._floatingIpRequired = arg.isFloatingIpRequired();
    }
    public NetsliceConnectionPointBuilder(org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon arg) {
        this._name = arg.getName();
        this._floatingIpRequired = arg.isFloatingIpRequired();
    }
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon) {
            this._name = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon)arg).getName();
            this._floatingIpRequired = ((org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon)arg).isFloatingIpRequired();
            isValidArg = true;
        }
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.SliceConnectionPoints) {
            this._connection = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.SliceConnectionPoints)arg).getConnection();
            isValidArg = true;
        }
