...
import org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetworkSliceType;
...
public class SNSSAIIdentifierBuilder implements Builder<SNSSAIIdentifier> {
    ...
    public SNSSAIIdentifierBuilder(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Snssai arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Snssai) {
            this._sliceServiceType = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Snssai)arg).getSliceServiceType();
            this._sliceDifferentiator = ((org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Snssai)arg).getSliceDifferentiator();
            isValidArg = true;
        }
